 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | <>|    | LGUI   | FN     | DEL    | SPACE  | BSPACE | LALT   | ENTER  | ALTGR  | RGUI   |        |        | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_COLEMAK] = {
     ...
     { KC_NUBS, KC_LGUI, MO(_FN), KC_DEL,  KC_SPC, KC_BSPC,  KC_LALT, KC_ENT,  SE_ALGR, KC_RGUI, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT  },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_MSEL, KC_UP  , KC_MYCM, KC_MAIL, RGB_HUD, RGB_HUI, KC_P7,   KC_P8,   KC_P9,   KC_MINS, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS  },
  { KC_LEFT, KC_DOWN, KC_RGHT, NO_LCBR, NO_RCBR, RGB_SAI, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, _______, RESET,   _______, _______, _______  },
 ...
 */
 ...
 [_QWERTY] = {
  { KC_ESC,  KC_2,    KC_1,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_GRV,  KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC  },
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_BSLS, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT  },
  { KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
